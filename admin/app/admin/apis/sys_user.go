...
func (e SysUser) GetPage(c *gin.Context) {
	...
	// #region agent log
	if err != nil {
		debugSessionLog167bb8("H3", "sys_user.go:GetPage", "sys_user_page_failed", map[string]any{"err": err.Error()})
	} else {
		debugSessionLog167bb8("H3", "sys_user.go:GetPage", "sys_user_page_ok", map[string]any{"n": len(list), "count": count})
	}
	// #endregion
	if err != nil {
...
func (e SysUser) GetInfo(c *gin.Context) {
	...
	if err != nil {
		e.Logger.Warnf("get user info from db error, userId=%d, err=%v, fallback to JWT claims", req.Id, err)
		mp["introduction"] = " am a super administrator"
		mp["avatar"] = "https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif"
		mp["userName"] = user.GetUserName(c)
		mp["userId"] = user.GetUserId(c)
		mp["deptId"] = 0
		mp["name"] = user.GetUserName(c)
		mp["code"] = 200
		e.OK(mp, "")
		return
	}
