...
func (e SysDictData) GetAll(c *gin.Context) {
	...
	// #region agent log
	if err != nil {
		debugSessionLog167bb8("H1", "sys_dict_data.go:GetAll", "dict_option_select_failed", map[string]any{"dictType": req.DictType, "err": err.Error()})
	} else {
		debugSessionLog167bb8("H1", "sys_dict_data.go:GetAll", "dict_option_select_ok", map[string]any{"dictType": req.DictType, "n": len(list)})
	}
	// #endregion
	if err != nil {
		e.Error(500, err, "查询失败")
