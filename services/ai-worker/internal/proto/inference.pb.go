...
type InferenceServiceClient interface {
	// 双向流式推理 - 实时音轨分离
	StreamSeparate(ctx context.Context, opts ...grpc.CallOption) (InferenceService_StreamSeparateClient, error)

	// 单次推理任务
	Separate(ctx context.Context, in *SeparateRequest, opts ...grpc.CallOption) (*SeparateResponse, error)

	// 提交批量任务
	SubmitBatch(ctx context.Context, in *BatchRequest, opts ...grpc.CallOption) (*BatchResponse, error)
...
func (c *inferenceServiceClient) StreamSeparate(ctx context.Context, opts ...grpc.CallOption) (InferenceService_StreamSeparateClient, error) {
	stream, err := c.cc.NewStream(ctx, &_InferenceService_serviceDesc.Streams[0], "/inference.InferenceService/StreamSeparate", opts...)
	if err != nil {
		return nil, err
	}
	x := &inferenceServiceStreamSeparateClient{stream}
	return x, nil
}

type InferenceService_StreamSeparateClient interface {
	Send(*AudioFrame) error
	Recv() (*SeparatedTrack, error)
	grpc.ClientStream
}

type inferenceServiceStreamSeparateClient struct {
	grpc.ClientStream
}

func (x *inferenceServiceStreamSeparateClient) Send(m *AudioFrame) error {
	return x.ClientStream.SendMsg(m)
}

func (x *inferenceServiceStreamSeparateClient) Recv() (*SeparatedTrack, error) {
	m := new(SeparatedTrack)
...
func (c *inferenceServiceClient) Separate(ctx context.Context, in *SeparateRequest, opts ...grpc.CallOption) (*SeparateResponse, error) {
	out := new(SeparateResponse)
	err := c.cc.Invoke(ctx, "/inference.InferenceService/Separate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *inferenceServiceClient) SubmitBatch(ctx context.Context, in *BatchRequest, opts ...grpc.CallOption) (*BatchResponse, error) {
	out := new(BatchResponse)
	err := c.cc.Invoke(ctx, "/inference.InferenceService/SubmitBatch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *inferenceServiceClient) GetTaskStatus(ctx context.Context, in *TaskStatusRequest, opts ...grpc.CallOption) (*TaskStatusResponse, error) {
	out := new(TaskStatusResponse)
	err := c.cc.Invoke(ctx, "/inference.InferenceService/GetTaskStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *inferenceServiceClient) GetTaskResult(ctx context.Context, in *TaskResultRequest, opts ...grpc.CallOption) (*TaskResultResponse, error) {
	out := new(TaskResultResponse)
	err := c.cc.Invoke(ctx, "/inference.InferenceService/GetTaskResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *inferenceServiceClient) CancelTask(ctx context.Context, in *CancelTaskRequest, opts ...grpc.CallOption) (*CancelTaskResponse, error) {
	out := new(CancelTaskResponse)
	err := c.cc.Invoke(ctx, "/inference.InferenceService/CancelTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *inferenceServiceClient) GetModelInfo(ctx context.Context, in *ModelInfoRequest, opts ...grpc.CallOption) (*ModelInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inference.InferenceService/GetModelInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *inferenceServiceClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inference.InferenceService/HealthCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// _InferenceService_serviceDesc 是服务描述符（用于注册服务）
var _InferenceService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Separate",
			Handler:    _InferenceService_Separate_Handler,
		},
		{
			MethodName: "SubmitBatch",
			Handler:    _InferenceService_SubmitBatch_Handler,
		},
		{
			MethodName: "GetTaskStatus",
			Handler:    _InferenceService_GetTaskStatus_Handler,
		},
		{
			MethodName: "GetTaskResult",
			Handler:    _InferenceService_GetTaskResult_Handler,
		},
		{
			MethodName: "CancelTask",
			Handler:    _InferenceService_CancelTask_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "StreamSeparate",
			Handler:       _InferenceService_StreamSeparate_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
...
func _InferenceService_Separate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SeparateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InferenceServiceServer).Separate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.InferenceService/Separate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InferenceServiceServer).Separate(ctx, req.(*SeparateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _InferenceService_SubmitBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InferenceServiceServer).SubmitBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.InferenceService/SubmitBatch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InferenceServiceServer).SubmitBatch(ctx, req.(*BatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _InferenceService_GetTaskStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InferenceServiceServer).GetTaskStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.InferenceService/GetTaskStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InferenceServiceServer).GetTaskStatus(ctx, req.(*TaskStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _InferenceService_GetTaskResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskResultRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InferenceServiceServer).GetTaskResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.InferenceService/GetTaskResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InferenceServiceServer).GetTaskResult(ctx, req.(*TaskResultRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _InferenceService_CancelTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InferenceServiceServer).CancelTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.InferenceService/CancelTask",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InferenceServiceServer).CancelTask(ctx, req.(*CancelTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _InferenceService_GetModelInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.InferenceService/GetModelInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _InferenceService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.InferenceService/HealthCheck",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _InferenceService_StreamSeparate_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(InferenceServiceServer).StreamSeparate(&inferenceServiceStreamSeparateServer{stream})
}

type inferenceServiceStreamSeparateServer struct {
	grpc.ServerStream
}

func (x *inferenceServiceStreamSeparateServer) Send(m *SeparatedTrack) error {
	return x.ServerStream.SendMsg(m)
}

func (x *inferenceServiceStreamSeparateServer) Recv() (*AudioFrame, error) {
	m := new(AudioFrame)
...
// RegisterInferenceServiceServer 注册 gRPC 服务
func RegisterInferenceServerServer(s *grpc.Server, srv InferenceServiceServer) {
